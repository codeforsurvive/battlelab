				...
				<div id="content" class="span12">
					...
					<ul class="breadcrumb">
						...
						<li>
							...
							<button class="btn btn-normal btn-info">Tambah Data Orang Tua Siswa</button>
							</p>
										...
										<form class="form-horizontal">
										  <fieldset>
											...
											<div class="control-group">
												<label for="selectError">Tampilkan data Orang Tua siswa berdasarkan :</label>
							...
							<div class="row-fluid sortable">
								...
								<div class="box-header" data-original-title>
									<h2><i class="halflings-icon white user"></i><span class="break"></span>Data Master Orang Tua Siswa</h2>
								</div>
								<div class="box-content">
									<table class="table table-striped table-bordered bootstrap-datatable datatable">
									  ...
									  <tbody>
										<tr>
											...
											<td class="center"></td>
											<td class="center"></td>
											<td class="center">Orang Tua atau Wali Siswa</td>
											<td class="center">
