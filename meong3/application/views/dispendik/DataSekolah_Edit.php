									...
									<div class="box-content">
										...
										<table>
											...
											<div class="control-group">
												<label class="control-label" for="selectError">Wilayah</label>
												<div class="controls">
													<input class="input-xlarge focused" name="kode_wilayah" id="focusedInput" type="text" value="<?php echo $a->KODE_WILAYAH;?>">
												</div>
											</div>
											<div class="control-group">
