		...
		<div class="container-fluid-full">
			...
			<div class="row-fluid">
				...
				<div id="content" class="span12">
					...
					<ul class="tabs">
							<li class="tab-link current" data-tab="tab-1">Mata Pelajaran</li>
							<li class="tab-link" data-tab="tab-2">Muatan Lokal</li>
									...
									<div class="box-content">
										<form class="form-horizontal">
										  <fieldset>
											...
											<div class="control-group hidden-phone">
											  <label class="control-label" for="textarea2">Deskripsi Mata Pelajaran</label>
											  <div class="controls">
												  <input class="input-xlarge focused" id="focusedInput" type="text" value="">
												</div>
											</div>
						...
						<div id="tab-2" class="tab-content">
							<div class="row-fluid sortable">
								<div class="box span8">
									<div class="box-header" data-original-title>
										<h2><i class="halflings-icon white user"></i><span class="break"></span>Kelola Muatan Lokal</h2>
									</div>
									<div class="box-content">
										<form class="form-horizontal">
										  <fieldset>
									...
									<div class="box-content">
										<form class="form-horizontal">
										  <fieldset>
											...
											<div class="control-group">
												<label class="control-label" for="focusedInput">Kode Ekstrakulikuler</label>
												<div class="controls">
												  <span class="input-xlarge uneditable-input">Some value here</span>
												</div>
											  </div>
									...
									<table class="table table-striped table-bordered bootstrap-datatable datatable">
									  <thead>
										  <tr>
											  ...
											  <th>Deskipsi Ekstrakulikuler</th>
											  <th>Aksi</th>
										  </tr>
									  </thead>   
									  <tbody>
