<script type="text/javascript">
    function fillFormDepartment(id) {
        var name = document.getElementById('dept_name_' + id).innerHTML;
    ...
    function showDeleteDepartmentModal(id) {
        var name = document.getElementById('dept_name_' + id).innerHTML;
        document.getElementById('delete_dept_form_id').value = id;
        $("#delete_dept_form_name").text(name);
        $("#deleteDeptModal").modal();
    }

    function confirmDeleteDepartment() {
        $("#deleteDeptModal").modal("hide");
        $("#delete_dept_form").submit();
    }
...
<div class="col-md-12">
    <div class="widget wgreen">
        <div class="widget-head">
            <div class="pull-left">Master Departemen</div>
        ...
        <div class="widget-content" style="padding: 10px">
            <div id="deleteDeptModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h4 class="modal-title">Konfirmasi penghapusan departemen</h4>
                        </div>
