                    ...
                    <div class="widget-content">
                        <div class="padd">
							 <ul id="myTab" class="nav nav-tabs">
							  <li class="active"><a href="#rab" data-toggle="tab">RAB</a></li>
							  <li><a href="#rabdetail" data-toggle="tab">RAB (detail)</a></li>
							  <li><a href="#rap" data-toggle="tab">RAP</a></li>
							</ul>
							<div id="myTabContent" class="tab-content">
								<div class="tab-pane fade in active" style="overflow-x: auto" id="rab">
									...
									<table class="table table-striped table-bordered centerTable" style="margin-top: 30px">
										<thead>
											<tr class="label-info">
												<th>No</th>
								...
								<div class="tab-pane fade" style="overflow-x: auto" id="rabdetail">
									<div style="width: 100%;" align="center"><h2><b>RINCIAN RAB (DETAIL)</b></h2></div>
								...
								<div class="tab-pane fade" style="overflow-x: auto" id="rap">
									<div style="width: 100%;" align="center"><h2><b>RINCIAN RAP</b></h2></div>
