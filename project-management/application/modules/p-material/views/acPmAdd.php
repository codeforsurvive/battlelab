...
<div class="col-md-12">
    <div class="widget wgreen">
        <div class="widget-head">
            <div class="pull-left">Tambah PM</div>
            ...
            <div class="page-tables">
                <div class="table-responsive">
                    <form id="formBPM" action="<?= base_url() . $this->uri->segment(1, 0) . '/' . $this->uri->segment(2, 0) ?>/createNew" method="post" class="form-horizontal" role="form">
                        ...
                        <input type="hidden" name="hutang_material_id" id="hutang_material_id" value="0"/>
                        <input type="hidden" name="kembali_material_id" id="kembali_material_id" value="0"/>
                        ...
                        <div class="form-group pemberi">
                            <label class="col-lg-2 control-label">HM</label>
                            <div class="col-lg-5">
                                <select name="" id="select_hm" class="form-control" onchange="">
                                    <option value="x">Pilih Hutang Material</option>
                                </select>
                            </div>
                            <div class="col-lg-2">
