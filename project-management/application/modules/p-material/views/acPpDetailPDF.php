...
<thead>
<tr class="label-info">
  <th colspan="6" <?= $header_keterangan ?>>Keterangan PP</th>
</tr>
</thead>
<tbody>
<tr>
  <td <?= $header_po ?>><b>Kode</b></td>
  <td <?= $content_po ?>><?= $PP['PERMINTAAN_PEMBELIAN_KODE']; ?></td>
...
<tr>
  <td <?= $header_po ?>><b>Status PP</b></td>
  <td><?= $PP['STATUS_PP_NAMA']; ?></td>
  <td <?= $header_po ?>><b>Kategori PP</b></td>
  <td><?= $PP['KATEGORI_PP_NAMA']; ?></td>
  <td <?= $header_po ?>><b>Gudang</b></td>
  <td><?= $PP['GUDANG_NAMA']; ?></td>
</tr>
<tr>
    <td <?= $header_po ?>><b>Tanggal Buat</b></td>
    <td><?= $PP['PERMINTAAN_PEMBELIAN_TANGGAL']; ?></td>
    <td <?= $header_po ?>><b>Tanggal Validasi</b></td>
    <td><?= $PP['PERMINTAAN_PEMBELIAN_VALIDATED']; ?></td>
