<!-- Page heading -->
<div class="page-head">
    <h2 class="pull-left"><i class="fa fa-building-o"></i>Edit Laporan Penerimaan Barang</h2>
    <!-- Breadcrumb -->
    <div class="bread-crumb pull-right">
        <a href="index.html"><i class="fa fa-home"></i> Home</a> 
        <!-- Divider -->
        <span class="divider">/</span> 
        <a href="<?= base_url() . $this->uri->segment(1, 0) . '/' . $this->uri->segment(2, 0) . '/index' ?>" class="bread-current">LPB</a>
        <span class="divider">/</span> 
...
<div class="col-md-12">
    <div class="widget wgreen">
        <div class="widget-head">
            <div class="pull-left">Edit LPB</div>
        ...
        <div class="widget-content" style="padding: 10px">
            <form id="formPB" action="<?= base_url() . $this->uri->segment(1, 0) . '/' . $this->uri->segment(2, 0) . '/edit' ?>" method="post">
                <input type="hidden" name="ID_LPB" value="<?= $lpb['PENERIMAAN_BARANG_ID'] ?>" id="id_lpb"/>
                <div class="page-tables">
                    <div class="table-responsive">
                        <div class="form-horizontal" role="form">
                            <div class="form-group">
                                <label class="col-lg-2 control-label">Kode LPB</label>
                                <div class="col-lg-5">
                                    <input name="" id="" class="form-control" value="<?= $lpb['PENERIMAAN_BARANG_KODE'] ?>" readonly=""/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-2 control-label">No Surat Jalan</label>
                                <div class="col-lg-5">
                                    <input name="LPB_SURAT_JALAN" id="LPB_SURAT_JALAN" class="form-control" placeholder="Nomor Surat Jalan" value="<?= $lpb['LPB_SURAT_JALAN'] ?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-2 control-label">No Kendaraan</label>
                                <div class="col-lg-5">
                                    <input name="LPB_KENDARAAN" id="LPB_KENDARAAN" class="form-control" placeholder="Nomor Kendaraan" value="<?= $lpb['LPB_KENDARAAN'] ?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-5">
                                    <select name="id_gudang" id="select_gudang" class="form-control">
                                        ...
                                        foreach ($list_gudang as $gudang) {
                                            echo '<option value="' . $gudang['GUDANG_ID'] . '" ' . ($lpb['GUDANG_ID'] == $gudang['GUDANG_ID'] ? 'selected=""' : '') . '>' . $gudang['GUDANG_KODE'] . ' ' . $gudang['GUDANG_NAMA'] . ' ' . $gudang['GUDANG_LOKASI'] . '</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-lg-5">
                                    <select name="id_supplier" id="select_supplier" class="form-control">
                                        ...
                                        foreach ($list_supplier as $supplier) {
                                            echo '<option value="' . $supplier['SUPPLIER_ID'] . '" ' . ($lpb['SUPPLIER_ID'] == $supplier['SUPPLIER_ID'] ? 'selected=""' : '') . '>' . $supplier['SUPPLIER_KODE'] . ' ' . $supplier['SUPPLIER_NAMA'] . ' ' . $supplier['SUPPLIER_ALAMAT'] . '</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                ...
                <div class="page-tables">
                    ...
                    <div class="row">
                        <?php if ($lpb['STATUS_LPB_ID'] == '1') {
                            ...
                            ?>
                            <div class="col-lg-6"> 
                                <button type="button" class="pull-right btn btn-lg btn-success saveForm" onclick="save('0')">Simpan Revisi</button>
                            </div>
                        <?php }
                        ?>
...
<script type="text/javascript" src="<?= base_url() ?>assets/default/js/p-material/lpb/jsedit.js"></script>