...
<div class="col-md-12">
    <div class="widget wgreen">
        <div class="widget-head">
            <div class="pull-left">Tambah Invoice Material Baru</div>
...
echo "<option value='" . $i[mMainProject::ID] . "'>" . $i[mMainProject::NAMA] . "</option>";
						...
						<div class="form-group" id="rab_form">
							...
							<div class="col-lg-5">
								<select class="form-control" id="rab" name="rab" onchange="changeRAB()">
						...
						<div class="form-group" id="supplier_form">
                            ...
                            <div class="col-lg-5">
                                <select name="supplier" id="supplier" class="form-control">
                                    <option disabled selected> -- pilih Suppplier -- </option>
                                </select>
                            </div>
                        </div>
...
<script>
    ...
    function save(param) {
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url(); ?>p-material/invoice/simpanInvoice",
			data: {RAB_ID: rab_id, SUPPLIER_ID: sup_id, STATUS_INVOICE_ID: param, TOP_ID: top, INVOICE_TOTAL: lpbTotal, LPB: lpbString}, 
			cache: false,
			success: function(result){
				if(result=="success") {
