...
<div class="col-md-12">
    <div class="widget wgreen">
        ...
        <div class="widget-content">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Konfirmasi penghapusan item lokasi upah</h4>
                        </div>
            ...
            <form method="POST" action="<?php echo base_url(); ?>master/lokasiupah/delete" id="form_delete">
            ...
            <div id="template_form_ubah" style="display:none;padding-top: 20px" class="alert-info col-lg-12">
                <form method="POST" action="<?php echo base_url(); ?>master/lokasiupah/update">
                    <input type="hidden" class="form-control" id="KATEGORI_SUPPLIER_ID" name="<?= mLokasiUpah::ID ?>">
                    <div class="col-lg-4">
                        <div class="form-horizontal" role="form">
                            <div class="form-group">
                                <label class="col-lg-5 control-label">Nama Lokasi Upah</label>
                                <div class="col-lg-7">
                                    <input type="text" class="form-control" id="KATEGORI_SUPPLIER_NAMA" name="<?= mLokasiUpah::NAME ?>" placeholder="Nama lokasi upah">
                                </div>
                            </div>
                            <div class="form-group">
            ...
            <div class="padd">
                <button type="button" class="btn btn-sm btn-primary" onclick="$('#form_tambah').slideToggle();"><i class="fa fa-plus fa-fw"></i> Tambahkan lokasi upah</button>
                <div class="clearfix">
                </div>
                <form method="POST" action="<?php echo base_url(); ?>master/lokasiupah/insert">
                    <div id="form_tambah" style="display:none">
                        <div class="form-horizontal" role="form">
                            <div class="form-group">
                                <label class="col-lg-2 control-label">Nama Lokasi Upah</label>
                                <div class="col-lg-5">
                                    <input type="text" class="form-control" id="KATEGORI_SUPPLIER_NAMA" name="<?= mLokasiUpah::NAME ?>" placeholder="Nama lokasi upah">
                                </div>
                            </div>
                            ...
                            <tbody>
                                ...
                                foreach ($listKategorisupplier as $item) {
                                    ...
                                    <tr id="item_<?php echo $id_bar; ?>">
                                        ...
                                        <td id="KATEGORI_SUPPLIER_NAMA_<?php echo $id_bar; ?>"><?php echo $item[mLokasiUpah::NAME]; ?></td>
