...
<div class="col-md-12">
    <div class="widget wgreen">
        ...
        <div class="widget-content">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Konfirmasi penghapusan item kategori barang</h4>
                        </div>
            ...
            <form method="POST" action="<?php echo base_url(); ?>master/kategoribarang/delete" id="form_delete">
            ...
            <div id="template_form_ubah" style="display:none;padding-top: 20px" class="alert-info col-lg-12">
                <form method="POST" action="<?php echo base_url(); ?>master/kategoribarang/update">
                    <input type="hidden" class="form-control" id="KATEGORI_SUPPLIER_ID" name="KATEGORI_BARANG_ID">
                    <div class="col-lg-4">
                        <div class="form-horizontal" role="form">
                            <div class="form-group">
                                <label class="col-lg-5 control-label">Nama Kategori Barang</label>
                                <div class="col-lg-7">
                                    <input type="text" class="form-control" id="KATEGORI_SUPPLIER_NAMA" name="KATEGORI_BARANG_NAMA" placeholder="Nama kategori barang">
                                </div>
                            </div>
                            <div class="form-group">
            ...
            <div class="padd">
                <button type="button" class="btn btn-sm btn-primary" onclick="$('#form_tambah').slideToggle();" ng-if="displayField(['kategori_barang_admin'])"><i class="fa fa-plus fa-fw"></i> Tambahkan kategori barang</button>
                <div class="clearfix">
                </div>
                <form method="POST" action="<?php echo base_url(); ?>master/kategoribarang/insert">
                    <div id="form_tambah" style="display:none">
                        <div class="form-horizontal" role="form">
                            <div class="form-group">
                                <label class="col-lg-2 control-label">Nama Kategori Barang</label>
                                <div class="col-lg-5">
                                    <input type="text" class="form-control" id="KATEGORI_SUPPLIER_NAMA" name="KATEGORI_BARANG_NAMA" placeholder="Nama kategori barang">
                                </div>
                            </div>
                ...
                <div class="page-tables" ng-if="displayField(['kategori_barang_admin', 'kategori_barang_viewer'])">
                    <!-- Table -->
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" id="data-table" width="100%" style="white-space: nowrap">
                            ...
                            <tbody>
                                ...
                                foreach ($listKategorisupplier as $item) {
                                    $id_bar = $item[mKategoriBarang::ID];
                                    ?>
                                    <tr id="item_<?php echo $id_bar; ?>">
                                        <td>
                                            <div class="btn-group" ng-if="displayField(['kategori_barang_admin'])">
                                        ...
                                        <td id="KATEGORI_SUPPLIER_NAMA_<?php echo $id_bar; ?>"><?php echo $item[mKategoriBarang::NAME]; ?></td>
