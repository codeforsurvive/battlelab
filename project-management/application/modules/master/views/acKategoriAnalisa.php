...
<div class="col-md-12">
    <div class="widget wgreen">
        ...
        <div class="widget-content">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Konfirmasi penghapusan item kategori analisa</h4>
                        </div>
            ...
            <form method="POST" action="<?php echo base_url(); ?>master/kategorianalisa/delete" id="form_delete">
            ...
            <div id="template_form_ubah" style="display:none;padding-top: 20px" class="alert-info col-lg-12">
                <form method="POST" action="<?php echo base_url(); ?>master/kategorianalisa/update">
                    <input type="hidden" class="form-control" id="KATEGORI_SUPPLIER_ID" name="<?= mKategoriAnalisa::ID ?>">
                    <div class="col-lg-4">
                        <div class="form-horizontal" role="form">
                            <div class="form-group">
                                <label class="col-lg-5 control-label">Nama Kategori Analisa</label>
                                <div class="col-lg-7">
                                    <input type="text" class="form-control" id="KATEGORI_SUPPLIER_NAMA" name="<?= mKategoriAnalisa::NAME ?>" placeholder="Nama kategori analisa">
                                </div>
                            </div>
                            <div class="form-group">
            ...
            <div class="padd">
                <button type="button" class="btn btn-sm btn-primary" onclick="$('#form_tambah').slideToggle();"><i class="fa fa-plus fa-fw"></i> Tambahkan kategori analisa</button>
                <div class="clearfix">
                </div>
                <form method="POST" action="<?php echo base_url(); ?>master/kategorianalisa/insert">
                    <div id="form_tambah" style="display:none">
                        <div class="form-horizontal" role="form">
                            <div class="form-group">
                                <label class="col-lg-2 control-label">Nama Kategori Analisa</label>
                                <div class="col-lg-5">
                                    <input type="text" class="form-control" id="KATEGORI_SUPPLIER_NAMA" name="<?= mKategoriAnalisa::NAME ?>" placeholder="Nama kategori analisa">
                                </div>
                            </div>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" id="data-table" width="100%" style="white-space: nowrap">
                            ...
                            <tbody>
                                ...
                                foreach ($listKategorisupplier as $item) {
                                    $id_bar = $item[mKategoriAnalisa::ID];
                                    ?>
                                    <tr id="item_<?php echo $id_bar; ?>">
                                        ...
                                        <td id="KATEGORI_SUPPLIER_NAMA_<?php echo $id_bar; ?>"><?php echo $item[mKategoriAnalisa::NAME]; ?></td>
