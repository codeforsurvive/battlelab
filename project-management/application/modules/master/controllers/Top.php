...
class Top extends Plan_Controller {
    ...
    public function index() {
        ...
        $this->title = "Master Top";
        $this->display('acTop', $this->data);
    }

    public function delete() {
        $this->mTop->_delete(array(mTop::ID => $this->input->post("tobe_deleted_id")), mTop::ACTIVE);
        redirect(base_url() . "master/top");
    }

    public function update() {
        $id = $this->input->post(mTop::ID);
		$data = array(
			mTop::KODE => $this->input->post(mTop::KODE),
			mTop::VALUE => $this->input->post(mTop::VALUE),
			mTop::DESCRIPTION => $this->input->post(mTop::DESCRIPTION)
		);
        $this->mTop->_update($data, array(mTop::ID => $id));
        redirect(base_url() . "master/top");
    }
    ...
    public function insert() {
        ...
        $this->mTop->_insert($data);
        redirect(base_url() . "master/top");
    }
	
	public function getViewTop(){
		 echo $this->mTop->getViewTop();
	}
